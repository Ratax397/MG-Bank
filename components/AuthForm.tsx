                        ...
                        {type === 'sign-up' && (
                          <>
                            <div className='flex gap-4'>
                              ...
                              <CustomInput 
                                control={form.control} name='firstName' label="First Name" placeholder="Enter you first name"
                              />
                            ...
                            <div className='flex gap-4'>
                              ...
                              <CustomInput 
                                control={form.control} name='dateOfBirth' label="Date of Birth" placeholder="Exemple: YYYY-MM-DD"
                              />
